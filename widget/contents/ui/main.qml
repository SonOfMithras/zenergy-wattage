...
PlasmoidItem {
    ...
    preferredRepresentation: root.showGraph ? fullRepresentation : compactRepresentation
    ...
    // Extracted out of fullRepresentation scope
    ...
    ColumnLayout {
        anchors.fill: parent
        anchors.leftMargin: isPlanar ? 12 : 2
        anchors.rightMargin: isPlanar ? 12 : 2
        anchors.topMargin: isPlanar ? 8 : 2
        anchors.bottomMargin: isPlanar ? 8 : 2
        spacing: isPlanar ? 4 : 0
            ...
            Connections {
                ...
                PlasmaComponents.Label {
                    ...
                    horizontalAlignment: Text.AlignHCenter
                    text: root.wattage
                    visible: root.cfgTextPosition === 1
